...
namespace NitroxModel.DataStructures.GameLogic
{
    ...
    public class ExosuitMovementData : VehicleMovementData
    {
        ...
        public ExosuitMovementData(TechType techType, string guid, Vector3 position, Quaternion rotation, Vector3 velocity, Vector3 angularVelocity, float steeringWheelYaw, float steeringWheelPitch, bool appliedThrottle,
