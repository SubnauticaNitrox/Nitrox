    ...
    public abstract class Packet
    {
        ...
        static Packet()
        {
                ...
                !t.IsAbstract))
            {
                ...
                StaticLogger.Instance.Debug("Added surrogate " + surrogate + " for type " + surrogatedType);
            }
        ...
        public static bool IsTypeSerializable(Type type)
        {
            ...
            return Serializer.SurrogateSelector.GetSurrogate(type, Serializer.Context, out selector) != null;
        }
