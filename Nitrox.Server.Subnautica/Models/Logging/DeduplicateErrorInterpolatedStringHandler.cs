...
internal ref struct DeduplicateErrorInterpolatedStringHandler(int literalLength, int formattedCount, ILogger logger, out bool enabled)
{
    public DeduplicateInterpolatedStringHandler InnerHandler = new(literalLength, formattedCount, logger, LogLevel.Error, out enabled);
