...
public class ServerCommandProcessor(ConsoleCommandProcessor cmdProcessor, ILogger<ServerCommandProcessor> logger) : AuthenticatedPacketProcessor<ServerCommand>
{
    private readonly ConsoleCommandProcessor cmdProcessor = cmdProcessor;
