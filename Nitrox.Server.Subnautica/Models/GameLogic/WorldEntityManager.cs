...
/// <remarks>
///     Regular <see cref="WorldEntity" /> are held in cells and should be registered in
///     <see cref="worldEntitiesByBatchId" /> and <see cref="worldEntitiesByCell" />.
...
/// </remarks>
internal class WorldEntityManager
{
    private readonly BatchEntitySpawnerService batchEntitySpawnerService;
    ...
    {
        List<Entity> spawnedEntities = batchEntitySpawnerService.LoadUnspawnedEntities(batchId, suppressLogs);
