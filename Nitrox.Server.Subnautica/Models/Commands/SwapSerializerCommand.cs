...
namespace Nitrox.Server.Subnautica.Models.Commands
{
    internal class SwapSerializerCommand : Command
    {
        ...
        public SwapSerializerCommand(IOptions<SubnauticaServerOptions> options, WorldService worldService) : base("swapserializer", Perms.CONSOLE, "Allows to change the save format")
        {
