...
internal class QueryCommand : Command
{
    ...
    public QueryCommand(EntityRegistry entityRegistry, SimulationOwnershipData simulationOwnershipData, ILogger<QueryCommand> logger) : base("query", Perms.CONSOLE, "Query the entity associated with the given NitroxId")
    {
