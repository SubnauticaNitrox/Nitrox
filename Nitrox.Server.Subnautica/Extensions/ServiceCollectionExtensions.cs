...
internal static partial class ServiceCollectionExtensions
{
    ...
    public static ILoggingBuilder AddNitroxLogging(this ILoggingBuilder builder)
    {
        ...
        return builder.AddZLoggerConsole(static (options, provider) => options.UseNitroxFormatter(formatterOptions =>
                      ...
                      .AddZLoggerInMemory((options, _) => options.UseNitroxFormatter(formatOptions =>
                      {
                          formatOptions.ColorBehavior = LoggerColorBehavior.Disabled;
                      }), processor => processor.MessageReceived += log => ServerTrackingService.LogQueue.Enqueue(log))
    ...
    public static IServiceCollection AddLocalhostApi(this IServiceCollection services) =>
        services
            .AddHostedSingletonService<ServerTrackingService>();
