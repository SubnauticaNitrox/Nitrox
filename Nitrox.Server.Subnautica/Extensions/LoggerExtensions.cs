...
{
    public static IDisposable? BeginOutputToPeerScope(this ILogger logger, string playerName) => logger.BeginScope(new OutputToPeerScope(playerName));
    ...
    public readonly record struct OutputToPeerScope(string PeerName);
