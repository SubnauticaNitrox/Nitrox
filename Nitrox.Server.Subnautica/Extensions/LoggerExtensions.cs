...
{
    public static IDisposable? BeginPlayerTargetScope(this ILogger logger, string playerName) => logger.BeginScope(new PlayerTargetScope(playerName));
    ...
    public readonly record struct PlayerTargetScope(string PlayerName);
