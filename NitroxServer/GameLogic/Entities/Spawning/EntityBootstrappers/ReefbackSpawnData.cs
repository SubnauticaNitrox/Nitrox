...
namespace NitroxServer.GameLogic.Entities.Spawning.EntityBootstrappers
{
    public static class ReefbackSpawnData
    {
        ...
        public static List<ReefbackEntity> SpawnableCreatures { get; } = new List<ReefbackEntity>()
        {
            ...
            new ReefbackEntity() { techType = TechType.Hoopfish, probability = 1, minNumber = 1, maxNumber = 1, classId = "08cb3290-504b-4191-97ee-6af1588af5c0" },
            ...
            new ReefbackEntity() { techType = TechType.Spadefish, probability = 1, minNumber = 1, maxNumber = 2, classId = "e82d3c24-5a58-4307-a775-4741050c8a78" },
