...
public static class WorldManager
{
    ...
    static WorldManager()
    {
        try
        {
            Directory.CreateDirectory(NitroxUser.SavesFolderDir);
        }
        catch (Exception ex)
        {
    ...
    public static IEnumerable<Listing> GetSaves()
    {
        ...
        foreach (string folder in Directory.EnumerateDirectories(NitroxUser.SavesFolderDir))
        {
            try
            {
    ...
    {
        string saveDir = Path.Combine(NitroxUser.SavesFolderDir, name);
        ...
        if (Directory.Exists(saveDir))
        {
            ...
            while (Directory.Exists(saveDir))
            {
                ...
                saveDir = Path.Combine(NitroxUser.SavesFolderDir, newSelectedWorldName);
                i++;
            }
