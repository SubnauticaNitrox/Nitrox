...
namespace NitroxPatcher.Patches.Dynamic
{
    public class BaseAddFaceGhost_UpdatePlacement_Patch : NitroxPatch, IDynamicPatch
    {
        ...
        public static bool Prefix(BaseAddFaceGhost __instance, ref bool __result, Transform camera, float placeMaxDistance, ref bool positionFound, ref bool geometryChanged, ConstructableBase ghostModelParentConstructableBase)
        {
