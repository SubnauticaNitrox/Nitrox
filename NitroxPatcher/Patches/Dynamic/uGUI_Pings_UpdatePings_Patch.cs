...
/// </summary>
public class uGUI_Pings_UpdatePings_Patch : NitroxPatch, IDynamicPatch
{
    internal static readonly MethodInfo TARGET_METHOD = Reflect.Method((uGUI_Pings t) => t.UpdatePings());
    ...
    public static IEnumerable<CodeInstruction> Transpiler(MethodBase original, IEnumerable<CodeInstruction> instructions)
    {
        ...
        foreach (CodeInstruction instruction in instructionList)
        {
            if (instruction.opcode.Equals(INJECTION_OPCODE) && instruction.operand.Equals(INJECTION_OPERAND))
            {
                 ...
                 * by
                 * bool flag = uGUI_Pings_UpdatePings_Patch.IsVisible(this);
                 */
