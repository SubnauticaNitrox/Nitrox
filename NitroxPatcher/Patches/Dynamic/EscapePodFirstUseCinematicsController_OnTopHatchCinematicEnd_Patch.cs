...
/// <summary>
/// Broadcasts escape pod metadata when the top hatch first-use cinematic ends.
/// This ensures other players know the hatch has been used and won't see the first-use cinematic.
/// </summary>
public sealed partial class EscapePodFirstUseCinematicsController_OnTopHatchCinematicEnd_Patch : NitroxPatch, IDynamicPatch
{
    private static readonly MethodInfo TARGET_METHOD = Reflect.Method((EscapePodFirstUseCinematicsController t) => t.OnTopHatchCinematicEnd(default));
