...
namespace NitroxPatcher.Patches.Dynamic
{
    public class BaseAddModuleGhost_UpdatePlacement_Patch : NitroxPatch, IDynamicPatch
    {
        ...
        {
            return NitroxServiceLocator.LocateService<Building>().BaseAddModuleGhost_UpdatePlacement_Pre(__instance, ref __result, camera, placeMaxDistance, ref positionFound, ref geometryChanged, ghostModelParentConstructableBase);
        }
