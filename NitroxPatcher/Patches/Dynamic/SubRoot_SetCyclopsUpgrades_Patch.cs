...
/// <summary>
/// The way Subnautica handles modules in Cyclops wrecks is pretty weird. If any module is added/removed, they
/// are all instantly disabled, which deletes creature decoys in any slot except the first one. We want to keep
/// the creature decoys around if the module is inserted, so we allow use of that module even when the Cyclops
/// has been destroyed.
/// </summary>
