...
namespace NitroxPatcher.Patches.Dynamic
{
    public class BaseGhost_Finish_Patch : NitroxPatch, IDynamicPatch
    {
        ...
        {
            NitroxServiceLocator.LocateService<GeometryLayoutChangeHandler>().baseGhostIsFinishing = true;
        }

        public static void Postfix(BaseGhost __instance)
        {
            NitroxServiceLocator.LocateService<GeometryLayoutChangeHandler>().baseGhostIsFinishing = false;
        }
