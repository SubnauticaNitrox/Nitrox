...
{
    public class ExosuitRemoveNonPilotUpdate_Patch : NitroxPatch
    {
        ...
        public static readonly Type OPERAND_CLASS = typeof(bool);
        public static readonly object INJECTION_OPERAND = OPERAND_CLASS.GetField("flag2", BindingFlags.Public | BindingFlags.Static);

        public static readonly OpCode INSTRUCTION_BEFORE_JUMP = OpCodes.Ldfld;
        public static readonly object INSTRUCTION_BEFORE_JUMP_OPERAND = typeof(Exosuit).GetField("flag5", BindingFlags.Public | BindingFlags.Instance);
        ...
        public static IEnumerable<CodeInstruction> Transpiler(MethodBase original, IEnumerable<CodeInstruction> instructions)
        {
            ...
            for (int i = 0; i < instructionList.Count; i++)
            {
                ...
                if (shouldInject)
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Call, typeof(MultiplayerBuilder).GetMethod("get_updateArmsOverride", BindingFlags.Public | BindingFlags.Static));
