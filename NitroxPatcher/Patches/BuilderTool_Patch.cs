...
namespace NitroxPatcher.Patches
{
    public class BuilderTool_OnHover_Patch : NitroxPatch
    {
        ...
        public static bool Prefix(BuilderTool __instance, bool __result, Constructable constructable)
        {
            ...
            _result = NitroxServiceLocator.LocateService<Crafting>().BuilderTool_Pre_OnHover(__instance.gameObject, constructable);
            if (_result == false)
            {
                return _result;
            }
        ...
        public static void Postfix(BuilderTool __instance, Constructable constructable)
        {
            ...
            {
                NitroxServiceLocator.LocateService<Crafting>().BuilderTool_Post_OnHover(__instance.gameObject, constructable);
            }
        }
    ...
    public class BuilderTool_HandleInput_Patch : NitroxPatch
    {
        ...
        public static bool Prefix(BuilderTool __instance)
        {
            ...
            _result = NitroxServiceLocator.LocateService<Crafting>().BuilderTool_Pre_HandleInput(__instance.gameObject);
            if (_result == false)
            {
                return _result;
            }
