...
namespace NitroxPatcher.Patches
{
    public class CrafterLogic_OnTryPickupSingle_Patch : NitroxPatch
    {
        ...
        {
            __result = NitroxServiceLocator.LocateService<Crafting>().CrafterLogic_Pre_OnTryPickupSingle(__instance.gameObject, techType);
            return __result;
        }

        public static void Postfix(CrafterLogic __instance, bool __result, TechType techType)
        {
            NitroxServiceLocator.LocateService<Crafting>().CrafterLogic_Post_OnTryPickupSingle(__instance.gameObject, __result, techType);
        }
