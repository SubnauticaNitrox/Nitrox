...
{
    /// <summary>
    /// Called whenever a Cyclops or Seamoth is spawned. Nitrox already has <see cref="Vehicles.CreateVehicle(Nitrox.Model.DataStructures.GameLogic.VehicleModel)"/> to
