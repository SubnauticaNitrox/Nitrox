...
For significant features, or if you are unsure, contact us on [Discord](https://discord.gg/E8B4X9s) before starting.

🚨 **We highly recommend visiting our [📜 documentation](https://subnauticanitrox.github.io/Documentation/), where you will find detailed setup and contribution guides.** 🚨
...
🔍 You can also help us verify issues that are [labeled with Status: To Verify](https://github.com/SubnauticaNitrox/Nitrox/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22Status%3A%20to%20verify%22).
...
Anyone can create a Pull Request by forking the _Nitrox_ repository. Once you have made changes in your feature branch, you can open a *Pull Request* targeting the `main` branch of the Nitrox repository.

- If you’re unsure where to make changes, ask us on [Discord](https://discord.gg/E8B4X9s).
