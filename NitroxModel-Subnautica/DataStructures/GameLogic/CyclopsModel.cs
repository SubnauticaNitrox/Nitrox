...
namespace NitroxModel_Subnautica.DataStructures.GameLogic
{
    ...
    public class CyclopsModel : VehicleModel
    {
        ...
        public CyclopsModel(NitroxTechType techType, List<InteractiveChildObjectIdentifier> interactiveChildIdentifiers, Optional<NitroxId> dockingBayId, string name, NitroxVector3[] hsb, float health)
