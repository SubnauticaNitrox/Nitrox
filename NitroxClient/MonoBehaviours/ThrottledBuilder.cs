...
namespace NitroxClient.MonoBehaviours
{
    ...
    public class ThrottledBuilder : MonoBehaviour
    {
        ...
        private void PlaceBasePiece(BasePiecePlacedEvent basePiecePlacedBuildEvent)
        {
            ...
            MultiplayerBuilder.overridePosition = basePiece.Transform.Position.ToUnity();
            MultiplayerBuilder.overrideQuaternion = basePiece.Transform.Rotation.ToUnity();
            ...
            MultiplayerBuilder.placePosition = basePiece.Transform.Position.ToUnity();
            MultiplayerBuilder.placeRotation = basePiece.Transform.Rotation.ToUnity();
            ...
            if (basePiece.Transform.Parent != null)
            {
                parentBase = NitroxEntity.GetObjectFrom(basePiece.Transform.Parent.Id).OrElse(null);
            }
