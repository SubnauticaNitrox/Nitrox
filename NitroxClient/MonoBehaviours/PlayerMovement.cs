...
namespace NitroxClient.MonoBehaviours
{
    public class PlayerMovement : MonoBehaviour
    {
        ...
        private Optional<VehicleMovementData> GetVehicleMovement()
        {
            ...
            float health;
            float steeringWheelYaw;
            float steeringWheelPitch;
            ...
            VehicleMovementData model = VehicleMovementFactory.GetVehicleMovementData(techType, id, position, rotation, velocity, angularVelocity,
                                                                                      steeringWheelYaw, steeringWheelPitch, appliedThrottle,
                                                                                      leftArmPosition, rightArmPosition, health);
