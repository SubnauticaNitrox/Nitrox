...
public class NetworkDebugger : AbstractDebugger, INetworkDebugger
{
    private const int WINDOW_ID = 422;
    private const int PACKET_STORED_COUNT = 100;

    private readonly Dictionary<Type, int> countByType = [];
    ...
    private readonly List<PacketDebugWrapper> packets = new(PACKET_STORED_COUNT);
    ...
    public NetworkDebugger() : base(WINDOW_ID, 600, null, KeyCode.N, true, false, false, GUISkinCreationOptions.DERIVEDCOPY, 330)
    {
    ...
    private void RenderPacketList(ToRender toRender)
    {
        ...
        PacketPrefixer prefixer = isSentList && isReceiveList ? PacketDirectionPrefixer : PacketNoopPrefixer;
