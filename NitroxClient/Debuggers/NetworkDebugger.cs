...
namespace NitroxClient.Debuggers
{
    ...
    public class NetworkDebugger : BaseDebugger, INetworkDebugger
    {
        ...
        {
            nameof(PlayerMovement), nameof(EntityTransformUpdates), nameof(PlayerStats), nameof(BatchEntities), nameof(VehicleMovement), nameof(PlayerCinematicControllerCall),
