...
namespace NitroxClient
{
    public class ClientAutoFacRegistrar : IAutoFacRegistrar
    {
        ...
        private void RegisterCoreDependencies(ContainerBuilder containerBuilder)
        {
            ...
            containerBuilder.RegisterType<PlayerPingSound>().InstancePerLifetimeScope();
            ...
            containerBuilder.RegisterType<ScannerRoomSnapshotStore>().InstancePerLifetimeScope();
            containerBuilder.RegisterType<ScannerRoomManager>().InstancePerLifetimeScope();
