...
/// </summary>
internal sealed class BatteryChildEntities(Entities entities)
{
    private readonly Entities entities = entities;

    public void TryPopulateInstalledBattery(GameObject gameObject, List<Entity> toPopulate, NitroxId parentId)
    {
    ...
    public void PopulateInstalledBattery(EnergyMixin energyMixin, List<Entity> toPopulate, NitroxId parentId)
    {
        ...
        CoroutineHost.StartCoroutine(entities.SpawnEntityAsync(installedBattery));
    }
}
