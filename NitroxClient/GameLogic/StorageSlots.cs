...
namespace NitroxClient.GameLogic
{
    public class StorageSlots
    {
        ...
        public void AddItem(GameObject item, NitroxId containerId, bool silent = false)
        {
            ...
            {
                Log.Instance.LogMessage(LogCategory.Error, "Add storage slot item: Could not find BatterySource field on object " + owner.name);
            }
        }
        ...
        public void RemoveItem(NitroxId ownerId, bool silent = false)
        {
            ...
            {
                Log.Instance.LogMessage(LogCategory.Error, "Removing storage slot item: Could not find storage slot field on object " + owner.name);
            }
        }
