...
public class Items
{
    ...
    public void Dropped(GameObject gameObject, TechType? techType = null)
    {
        ...
        else if (gameObject.TryGetComponent(out OxygenPipe oxygenPipe))
        {
            ...
            {
                DisplayStatusCode(StatusCode.subnauticaError, false, $"Couldn't find a valid reference to the OxygenPipe's parent pipe");
                return;
            }
            ...
            {
                DisplayStatusCode(StatusCode.subnauticaError, false, $"Couldn't find a valid reference to the OxygenPipe's root pipe");
                return;
            }
    ...
    public static InventoryItemEntity ConvertToInventoryItemEntity(GameObject gameObject, EntityMetadataManager entityMetadataManager)
    {
        ...
        {
            DisplayStatusCode(StatusCode.remotePlayerErr, true, "[Items] Player has no id! Couldn't parent InventoryItem.");
        }
