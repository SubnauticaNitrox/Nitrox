    ...
    public class Fires
    {
        ...
        public void Create(CyclopsFireData fireData)
        {
            ...
            if (transform2.childCount > 0)
            {
                ...
                {
                    Log2.Instance.LogMessage(NLogType.Error, "[Fires.Create Fire already exists at node index " + fireData.NodeIndex
            ...
            {
                Log2.Instance.LogMessage(NLogType.Error, "[FireCreatedProcessor Cannot create new Cyclops fire! PrefabSpawn component could not be found in fire node!"
