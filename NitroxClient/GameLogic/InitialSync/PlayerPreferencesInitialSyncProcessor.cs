...
public class PlayerPreferencesInitialSyncProcessor : InitialSyncProcessor
{
    ...
    // Ansother type is Signal pings that are generated by the story events, they are located in the Global Root and don't contain a NitroxEntity, to be identified, they have another object: a SignalPing which contains a description key
    // The last type possible is RemotePlayers' pings which are located in a GameObject that is 2 step under the main object
    /// <summary>
