...
internal sealed class SimulationOwnership(IMultiplayerSession multiplayerSession, IPacketSender packetSender, EntityPositionBroadcastService entityPositionBroadcastService)
{
    private readonly IMultiplayerSession multiplayerSession = multiplayerSession;
    private readonly EntityPositionBroadcastService entityPositionBroadcastService = entityPositionBroadcastService;
    ...
    public void TreatSimulatedEntity(SimulatedEntity simulatedEntity)
    {
        ...
        if (isLocalPlayerNewOwner)
        {
            ...
            {
                entityPositionBroadcastService.WatchEntity(simulatedEntity.Id);
            }
        ...
        else if (HasAnyLockType(simulatedEntity.Id))
        {
            ...
            entityPositionBroadcastService.StopWatchingEntity(simulatedEntity.Id);
        }
    ...
    public void DropSimulationFrom(NitroxId entityId)
    {
        ...
        entityPositionBroadcastService.StopWatchingEntity(entityId);
