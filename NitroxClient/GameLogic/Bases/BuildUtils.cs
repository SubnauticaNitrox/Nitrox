...
public static class BuildUtils
{
    ...
    public static bool TryTransferIdFromGhostToModule(BaseGhost baseGhost, NitroxId id, ConstructableBase constructableBase, out GameObject moduleObject)
    {
            ...
            isWaterPark)
        {
            ...
            {
                DisplayStatusCode(StatusCode.SUBNAUTICA_ERROR, $"Couldn't find the module spawned by {baseGhost}");
                moduleObject = null;
                return false;
            }
        }
        ...
        if (!face.HasValue)
        {
            ...
            {
                DisplayStatusCode(StatusCode.SUBNAUTICA_ERROR, $"No face could be found for ghost {baseGhost}");
            }
            moduleObject = null;
            return false;
        }
        ...
        if (isMapRoomGhost)
        {
            ...
            DisplayStatusCode(StatusCode.SUBNAUTICA_ERROR, $"Couldn't find MapRoomFunctionality of built MapRoom (cell: {face.Value.cell})");
            moduleObject = null;
            return false;
        }
