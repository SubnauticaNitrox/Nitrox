...
namespace NitroxClient.GameLogic
{
    public class Cyclops
    {
        ...
        {
            vehicles.GetVehicle<CyclopsModel>(id).InternalLightsOn = isOn;
        ...
        {
            vehicles.GetVehicle<CyclopsModel>(id).FloodLightsOn = isOn;
        ...
        {
            vehicles.GetVehicle<CyclopsModel>(id).SilentRunningOn = isOn;
        ...
        {
            vehicles.GetVehicle<CyclopsModel>(id).EngineMode = mode;
        ...
        {
            vehicles.GetVehicle<CyclopsModel>(id).EngineState = isStarting;
        ...
        {
            vehicles.GetVehicle<CyclopsModel>(id).SonarOn = active;
            CyclopsChangeSonarMode packet = new(id, active);
            packetSender.SendIfGameCode(packet);
        }

        public void BroadcastSonarPing(NitroxId id)
        {
            packetSender.SendIfGameCode<CyclopsSonarPing>(new (id));
        }

        public void BroadcastChangeShieldState(NitroxId id, bool isOn)
        {
            vehicles.GetVehicle<CyclopsModel>(id).ShieldOn = isOn;
            packetSender.SendIfGameCode<CyclopsChangeShieldMode>(new(id, isOn));
        }

        public void BroadcastActivateFireSuppression(NitroxId id)
        {
            packetSender.SendIfGameCode<CyclopsFireSuppression>(new(id));
        }
