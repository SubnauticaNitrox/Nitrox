...
namespace NitroxClient.GameLogic
{
    public class MobileVehicleBay
    {
        ...
        public MobileVehicleBay(IPacketSender packetSender, INitroxLogger logger)
        {
        ...
        {
            string constructorGuid = constructor.GetGuid();
            ...
            if (opConstructedObject.IsPresent())
            {
                ...
                string constructedObjectGuid = constructedObject.GetGuid();
