...
public class NitroxSettingsManager
{
    ...
    {
        AddSetting("Nitrox_StreamerSettings", new Setting("Nitrox_ChatVisibilityDuration", NitroxPrefs.ChatVisibilityDuration, duration => NitroxPrefs.ChatVisibilityDuration.Value = (int)duration, 0f, 15f, NitroxPrefs.ChatVisibilityDuration.DefaultValue, 1f, SliderLabelMode.Int, "0", "Nitrox_ChatVisibilityDuration_Tooltip"));
