...
internal sealed class NitroxSettingsService(BuildingService buildingService) : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        AddSetting("Nitrox_Settings_Privacy",
                   new Setting("Nitrox_Settings_ChatVisibilityDuration", NitroxPrefs.ChatVisibilityDuration, duration => NitroxPrefs.ChatVisibilityDuration.Value = (int)duration, 1f, 15f, NitroxPrefs.ChatVisibilityDuration.DefaultValue, 1f,
                               SliderLabelMode.Int, "0", "Nitrox_Settings_ChatVisibilityDuration_Tooltip"));
        ...
        AddSetting("Nitrox_BuildingSettings", new Setting("Nitrox_ResyncBuildings", () => buildingService.AskForResync()));

        AddSetting("Nitrox_Settings_Bandwidth",
                   new Setting("Nitrox_Settings_LatencyUpdatePeriod", NitroxPrefs.LatencyUpdatePeriod, latencyUpdatePeriod => NitroxPrefs.LatencyUpdatePeriod.Value = (int)latencyUpdatePeriod, 1, 60, NitroxPrefs.LatencyUpdatePeriod.DefaultValue, 1,
                               SliderLabelMode.Int, tooltip: "Nitrox_Settings_HigherForUnstable_Tooltip"));
        AddSetting("Nitrox_Settings_Bandwidth",
                   new Setting("Nitrox_Settings_SafetyLatencyMargin", NitroxPrefs.SafetyLatencyMargin, safetyLatencyMargin => NitroxPrefs.SafetyLatencyMargin.Value = safetyLatencyMargin, 0.01f, 0.5f, NitroxPrefs.SafetyLatencyMargin.DefaultValue, 0.01f,
                               SliderLabelMode.Float, "0.00", "Nitrox_Settings_HigherForUnstable_Tooltip"));
        AddSetting("Nitrox_Settings_Bandwidth",
                   new Setting("Nitrox_Settings_OfflineClockSyncDuration", NitroxPrefs.OfflineClockSyncDuration, offlineClockSyncDuration => NitroxPrefs.OfflineClockSyncDuration.Value = (int)offlineClockSyncDuration, 3, 15,
                               NitroxPrefs.OfflineClockSyncDuration.DefaultValue, 1, SliderLabelMode.Int, tooltip: "Nitrox_Settings_HigherForUnstable_Tooltip"));
    ...
    public sealed class Setting
    {
        ...
        public Setting(string label, NitroxPref nitroxPref, UnityAction<float> callback, float sliderMinValue, float sliderMaxValue, float sliderDefaultValue, float sliderStep, SliderLabelMode labelMode, string floatFormat = "0", string tooltip = null) :
            this(SettingType.SLIDER, label, nitroxPref, callback)
        {
