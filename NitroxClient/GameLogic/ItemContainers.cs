...
namespace NitroxClient.GameLogic
{
    public class ItemContainers
    {
        ...
        public void AddItem(GameObject item, NitroxId containerId)
        {
            ...
            {
                Log2.Instance.Log(NLogType.Error, "Could not find container field on object " + owner.Get().name);
            }
        }
        ...
        public void RemoveItem(NitroxId ownerId, NitroxId itemId)
        {
            ...
            {
                Log2.Instance.Log(NLogType.Error, "Could not find container field on object " + owner.name);
            }
        }
