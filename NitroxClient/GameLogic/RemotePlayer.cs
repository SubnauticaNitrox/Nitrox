...
namespace NitroxClient.GameLogic
{
    public class RemotePlayer : INitroxPlayer
    {
        ...
        private void EquipRadiationSuit()
        {
            ...
            HsvColorFilter legFilter = new HsvColorFilter(playerHue, 100f, playerVibrancy, -1f);
            legFilter.AddSaturationRange(0f, 35f);
            legFilter.AddVibranceRange(40f, 100f);

            HsvColorFilter feetFilter = new HsvColorFilter(playerHue, -1f, playerVibrancy, -1f);
            feetFilter.AddHueRange(0f, 100f);
            feetFilter.AddVibranceRange(30f, 100f);

            HsvColorFilter beltFilter = new HsvColorFilter(playerHue, 100f, playerVibrancy, -1f);
            beltFilter.AddVibranceRange(3f, 100f);
            beltFilter.AddHueRange(0f, 90f);
            ...
            bodyRenderer.materials[0].mainTexture = bodyTexture;
            bodyRenderer.materials[0].SetTexture("_SpecTex", bodyTexture);
            //bodyRenderer.materials[0].ApplyFiltersToMainTexture(hueFilter);
        ...
        private void EquipReinforcedSuit()
        {
            ...
            HsvColorFilter helmetFilter = new HsvColorFilter(playerHue, 100f, playerVibrancy, -1f);
            helmetFilter.AddSaturationRange(0f, 35f);
            helmetFilter.AddVibranceRange(30f, 100f);

            HsvColorFilter vestFilter = new HsvColorFilter(playerHue, 100f, playerVibrancy, -1f);
            vestFilter.AddSaturationRange(0f, 35f);
            vestFilter.AddVibranceRange(12f, 100f);

            HsvColorFilter bodyFilter = new HsvColorFilter(playerHue, -1f, -1f, -1f);
            bodyFilter.AddHueRange(0f, 20f);
            bodyFilter.AddSaturationRange(45f, 100f);
        ...
        private void EquipStillSuit()
        {
            ...
            HsvColorFilter tankFilter = new HsvColorFilter(playerHue, -1f, -1f, -1f);
            tankFilter.AddHueRange(0f, 19f);
            
            HsvColorFilter bodyFilter = new HsvColorFilter(playerHue, -1f, -1f, -1f);
            bodyFilter.AddHueRange(0f, 75f);

            HsvColorFilter helmetFilter = new HsvColorFilter(playerHue, -1f, -1f, -1f);
            helmetFilter.AddHueRange(0f, 25f);
            ...
            helmetRenderer.material.shaderKeywords = new List<string>() { "UWE_DITHERALPHA", "MARMO_SIMPLE_GLASS", "MARMO_SPECMAP", "WBOIT", "_NORMALMAP", "_ZWRITE_ON" }.ToArray();
            helmetRenderer.material.SetOverrideTag("RenderType", "Transparent");
            ...
            helmetRenderer.materials[2].shaderKeywords = new List<string>() { "MARMO_SPECMAP", "_ZWRITE_ON" }.ToArray();
