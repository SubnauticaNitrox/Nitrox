...
internal sealed class MainMenuModsService(JoinServerBackend joinServerBackend) : IGameService
{
    private MainMenuRightSide rightSide;
    private readonly JoinServerBackend joinServerBackend = joinServerBackend;
    ...
    private void MultiplayerMenuMods()
    {
        ...
        serverJoin.AddComponent<MainMenuJoinServerPanel>().Setup(savedGamesRef, joinServerBackend);
