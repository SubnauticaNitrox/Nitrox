...
internal sealed class LiteNetLibClientService : IClient, IGameService
{
    ...
    public LiteNetLibClientService(PacketReceiver packetReceiver, INetworkDebugger networkDebugger = null)
    {
