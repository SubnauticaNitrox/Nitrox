...
internal sealed class NitroxProtobufSerializerService(IEnumerable<string> protobufTypeAssemblies) : BackgroundService
{
    public readonly Dictionary<Type, int> NitroxTypes = [];
    private readonly IEnumerable<string> protobufTypeAssemblies = protobufTypeAssemblies;
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        foreach (string assembly in protobufTypeAssemblies)
        {
