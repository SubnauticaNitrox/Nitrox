...
namespace NitroxClient.Communication.Packets.Processors
{
    public class ExosuitArmActionProcessor : ClientPacketProcessor<ExosuitArmActionPacket>
    {
        ...
        public override void Process(ExosuitArmActionPacket packet)
        {
            ...
            {
                Log.Instance.LogMessage(LogCategory.Error, "Could not find exosuit arm");
                return;
            }
            ...
            switch (packet.TechType)
            {
                ...
                case TechType.ExosuitTorpedoArmModule:                    
                    ...
                    break;
                default:
                    Log.Instance.LogMessage(LogCategory.Error, "Got an arm tech that is not handled: " + packet.TechType + " with action: " + packet.ArmAction + " for id " + packet.ArmId);
                    break;
            }
