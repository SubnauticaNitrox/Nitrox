...
public class FootstepIPacketProcessor : IClientPacketProcessor<FootstepPacket>
{
    ...
    public FootstepIPacketProcessor(PlayerManager remotePlayerManager, FmodWhitelist whitelist)
    {
    ...
    public Task Process(IPacketProcessContext context, FootstepPacket packet)
    {
