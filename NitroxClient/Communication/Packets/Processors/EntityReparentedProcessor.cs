...
public class EntityReparentedProcessor : IClientPacketProcessor<EntityReparented>
{
    ...
    public Task Process(IPacketProcessContext context, EntityReparented packet)
    {
