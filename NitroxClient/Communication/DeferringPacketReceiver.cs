...
namespace NitroxClient.Communication
{
    public class DeferringPacketReceiver
    {
        ...
        private readonly NitroxModel.DataStructures.PriorityQueue<Packet> receivedPackets = new NitroxModel.DataStructures.PriorityQueue<Packet>();  // really sorry, I stole your fix nesrak1
