...
internal sealed partial class uGUI_SceneIntro_HandleInput_Patch : NitroxPatch, IDynamicPatch
{
    ...
    public uGUI_SceneIntro_HandleInput_Patch(PlayerCinematics pc, LocalPlayer lp)
    {
        playerCinematics = pc;
        localPlayer = lp;
    }
    ...
    private static bool HandleButtonHeld(uGUI_SceneIntro instance)
    {
        ...
        {
            playerCinematics.SetLocalIntroCinematicMode(IntroCinematicMode.SINGLEPLAYER);
        ...
        if (!uGUI_SceneIntro_IntroSequence_Patch.IsWaitingForPartner &&
            localPlayer.IntroCinematicMode == IntroCinematicMode.SINGLEPLAYER) // Skipping intro alone
        {
