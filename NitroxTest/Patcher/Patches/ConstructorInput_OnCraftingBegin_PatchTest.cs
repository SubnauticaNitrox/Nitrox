...
namespace NitroxTest.Patcher.Patches
{
    ...
    public class ConstructorInput_OnCraftingBegin_PatchTest
    {
        ...
        public void Sanity()
        {
            ...
            MethodInfo method = typeof(ConstructorInput).GetMethod("OnCraftingBegin", BindingFlags.NonPublic | BindingFlags.Instance);
            IEnumerable<CodeInstruction> result = ConstructorInput_OnCraftingBegin_Patch.Transpiler(method, instructions);
        ...
        {
            List<CodeInstruction> beforeInstructions = PatchTestHelper.GetInstructionsFromMethod(ConstructorInput_OnCraftingBegin_Patch.TARGET_METHOD);
