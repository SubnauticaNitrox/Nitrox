...
namespace NitroxServer.GameLogic
{
    ...
    public class EventTriggererTest
    {
        ...
        {
            EventTriggerer eventTriggerer = new(null, null, null, seed, 0.0, null, null, null);
        ...
        {
            EventTriggerer eventTriggerer = new(null, null, null, seed, 0.0, TimeSpan.FromMinutes(40).TotalMilliseconds, null, null);
        ...
        {
            EventTriggerer eventTriggerer = new(null, null, null, seed, 480.0, null, null, null);
        ...
        {
            EventTriggerer eventTriggerer = new(null, null, null, seed, 890000, 2400000, 480000, null);
            eventTriggerer.PauseWorld();

            Assert.AreEqual(4, eventTriggerer.eventTimers.Count);

            eventTriggerer = new(null, null, null, seed, 1500000, 2400000, 480000, null);
            eventTriggerer.PauseWorld();

            Assert.AreEqual(3, eventTriggerer.eventTimers.Count);

            eventTriggerer = new(null, null, null, seed, 2016000, 2400000, 480000, null);
            eventTriggerer.PauseWorld();
