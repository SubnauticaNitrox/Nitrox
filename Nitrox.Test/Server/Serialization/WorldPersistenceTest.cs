        ...
        return new PersistedWorldData()
        {
            ...
            EntityData =
                new EntityData()
                {
                    ...
                    {
                        new PrefabChildEntity(new NitroxId(), "pretty class id", new NitroxTechType("Fabrifactor"), 1, new CrafterMetadata(new NitroxTechType("FilteredWater"), 100, 10), new NitroxId()),
