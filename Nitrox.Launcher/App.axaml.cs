...
internal class App : Application
{
    ...
    public static AppBuilder Create()
    {
        ...
        StartupWindowFactory ??= () =>
        {
            ...
            {
                options.Listen(IPAddress.Any, LauncherConstants.LAUNCHER_SERVER_TRACK_PORT, o => o.Protocols = HttpProtocols.Http2);
            });
            WebApplication host = hostBuilder.Build();
            host.MapMagicOnionService();
            host.MapGrpcService<ServerTrackingApiService>();
