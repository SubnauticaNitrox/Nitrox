...
using Nitrox.Launcher.Events;
using Nitrox.Launcher.Pages;
using Nitrox.Launcher.Patching;
using Nitrox.Model;
...
namespace Nitrox.Launcher
{
    public class LauncherLogic : IDisposable, INotifyPropertyChanged
    {
        ...
        internal Process StartServer(bool standalone)
        {
            ...
            string serverPath = Path.Combine(launcherDir, "Nitrox.Server.Subnautica.exe");
